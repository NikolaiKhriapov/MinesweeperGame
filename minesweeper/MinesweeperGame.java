...
public class MinesweeperGame extends Game
{
    ...
    private void openTile(int x, int y)
    {
        ...
        if (isGameStopped == true || gameObject.isFlag == true || gameObject.isOpen)
            return;
    ...
    {
        showMessageDialog(Color.GRAY, "Game Over", Color.BLACK, 70);
        isGameStopped = true;
    }

    private void win()
    {
        showMessageDialog(Color.GRAY, "YOU WIN", Color.BLACK, 70);
        isGameStopped = true;
    }
